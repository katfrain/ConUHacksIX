...
import { Image, View, Text, StyleSheet, TextInput, ActivityIndicator, Button, KeyboardAvoidingView, TouchableOpacity} from 'react-native';
...
import {Cabin_400Regular,   Cabin_500Medium,   Cabin_600SemiBold,   Cabin_700Bold,   Cabin_400Regular_Italic,   Cabin_500Medium_Italic,   Cabin_600SemiBold_Italic,   Cabin_700Bold_Italic, } from '@expo-google-fonts/cabin';
                ...
                <KeyboardAvoidingView behavior="padding">
                    ...
                    <>
                        <TouchableOpacity
                            ...
                            onPress={signIn}
                        >
                            <Text style={{ color: 'white', fontSize: 24, fontFamily: 'Cabin' }}>login</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={styles.LoginButton}
                            onPress={signUp}
                        >
                            <Text style={{ color: 'white', fontSize: 24, fontFamily: 'Cabin' }}>sign up!</Text>
                        </TouchableOpacity>
                    </>
                    )
                    }
